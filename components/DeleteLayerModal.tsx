      ...
      <div className="w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-700 dark:bg-slate-800">
        ...
        <div className="mb-4 flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-semibold text-slate-800 dark:text-slate-100">Delete Layer</h2>
          </div>
          <button
            onClick={onCancel}
        ...
        <p className="text-sm text-slate-600 dark:text-slate-300">
          ...
          <span className="font-semibold text-slate-800 dark:text-slate-100">&ldquo;{layerName}&rdquo;</span>?
        </p>
