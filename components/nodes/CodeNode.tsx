...
export default function CodeNode({ id, data, selected }: NodeProps<NodeData>) {
  return (
    <div
      className={`relative min-w-[140px] rounded-xl border-2 bg-red-50 shadow-sm transition-all ${
        selected
    ...
    >
      <NodeResizer minWidth={120} minHeight={80} isVisible={selected} lineClassName="border-red-700" handleClassName="h-2.5 w-2.5 rounded-full bg-red-700" />
      ...
      <div className="flex flex-col items-center gap-1 px-4 py-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-red-50">
          <Code size={20} className="text-red-700" />
        </div>
