...
export default function GatewayNode({ id, data, selected }: NodeProps<NodeData>) {
  return (
    <div
      className={`relative min-w-[140px] rounded-xl border-2 bg-orange-50 shadow-sm transition-all ${
        selected
    ...
    >
      <NodeResizer minWidth={120} minHeight={80} isVisible={selected} lineClassName="border-orange-400" handleClassName="h-2.5 w-2.5 rounded-full bg-orange-400" />
